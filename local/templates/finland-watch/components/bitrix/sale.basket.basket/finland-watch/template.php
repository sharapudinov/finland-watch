...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	?>
		<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="basket_form" id="basket_form">
            ...
            <p class="checkout"><a href="#" class="as-credit">Как оформить кредит?</a><a href="#" class="credit">оформить кредит</a><input  onclick="checkOut();" type="submit" name="" value="<?= GetMessage("SALE_ORDER") ?>" /></p>
		</form>
