...
<div class="history">
	<ul>
        <li><a class="bx_mo_link" href="<?=$arResult["URL_TO_LIST"]?>"><?=GetMessage('SPOD_CUR_ORDERS')?></a></li>
    </ul>
</div>
	...
	<?else:?>
		...
		<table>
				...
				<?if(intval($arResult["USER_ID"])):?>
					...
					<tr>
						<th colspan="2"><?=GetMessage('SPOD_ACCOUNT_DATA')?></th>
					</tr>
				...
				<tr>
					<th colspan="2"><?=GetMessage('SPOD_ORDER_PROPERTIES')?></th>
				</tr>
				<tr>
				...
				*/?>
				...
				<?foreach($arResult["ORDER_PROPS"] as $prop):?>
					...
					<?if($prop["SHOW_GROUP_NAME"] == "Y"):?>
						...
						<tr><td><br></td><td></td></tr>
						<tr>
							<th colspan="2"><?=$prop["GROUP_NAME"]?></th>
						</tr>
				...
				<tr>
					<th colspan="2"><?=GetMessage("SPOD_ORDER_PAYMENT")?></th>
				</tr>
				<tr>
		...
		<table>
				<tr>
					...
					<th class="custom price"><?=GetMessage('SPOD_PRICE')?></th>

					<?if($arResult['HAS_PROPS']):?>
						<th class="custom amount"><?=GetMessage('SPOD_PROPS')?></th>
					<?endif?>
					
					<?if($arResult['HAS_DISCOUNT']):?>
						<th class="custom price"><?=GetMessage('SPOD_DISCOUNT')?></th>
					<?endif?>

					<th class="custom amount"><?=GetMessage('SPOD_PRICETYPE')?></th>
					<th class="custom price"><?=GetMessage('SPOD_QUANTITY')?></th>
				</tr>
