        ...
        <section>
            <div class="main-block-about">
                ...
                <div class="about-left">
                    <p>Мы рады приветствовать Вас на нашем сайте, сайте официального дилера в РФ известной финской
                        компании
                        <span class="blue">Suunto.</span></p>

                    <p> У нас Вы всегда сможете купить продукцию данного производителя. В ассортименте представлены
                        надежные
                    ...
                    <p>Чем же сегодня занимается <span class="blue">компания Suunto</span>?<br/>
                        ...
                        многофункциональных устройств. Компания Suunto так же, как и её изделия, давно уже стала
                        надежным
                        спутником и верным другом для многих искателей приключений. Используют её и дайверы, и лыжники,
                        и
                    ...
                    <p><span class="blue">Навигационные устройства с GPS,</span> а также <span class="blue">спортивные электронные часы, компасы</span>
                        и <span class="blue">наручные компьютеры Suunto</span> часто становятся воплощением особого
                        стиля.
                    </p>
                ...
                <div class="about-right">
                    ...
                    <p><span class="blue">Suunto (Сунто) в России:</span> общая информация<br/>
                        Сегодня приобрести оригинальную продукцию данного производителя не так просто. Финские
                        спортивные
                    ...
                    <p>Важно уже то, что существует наш магазин, и здесь <span class="blue">Вы сможете купить оригинальную продукцию компании Suunto (Сунто). </span>Кроме
                        ...
                        Как приобрести продукцию Suunto? Всё очень просто. Чтобы заказать часы с GPS или классические
                        Suunto
                        (<span class="blue">электронные спортивные часы</span>), компас или наручный компьютер,
                        достаточно
                    ...
                    <div class="questions">
                        ...
                        <p> Задать их Вы всегда сможете опытным менеджерам. Они проконсультируют Вас по продукции
                            Suunto,
